...
const acrcloud = require(__dirname + '/modules/acr')
const {
    unixTimestampSecond,
    generateMessageTag,
    processTime,
...
const { sck1 } = require(__dirname + '/modules/user')
const { sck } = require(__dirname + '/modules/group')
const { RandomXP } = require(__dirname + '/modules/xp')
const { plugindb } = require(__dirname + '/modules/plugins')
const { warndb } = require(__dirname + '/modules/warn')
const { notes } = require(__dirname + '/modules/notes')
const { haigu } = require(__dirname + '/modules/cards')
const { card } = require(__dirname + '/modules/cards')
const { cmd, commands } = require(__dirname + '/commands')
const { chatbot } = require(__dirname+'/modules/chatbot')
module.exports = {
    sck,
    cmd,
    commands,
